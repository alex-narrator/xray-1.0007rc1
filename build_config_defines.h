...
#define MODIFY_ACTOR_CONFIG_PARAMS     // позволяет изменять в процессе игры параметры Actor.ltx (прыжок, бег, базовый разброс оружия). 
//#define MODIFY_ACTOR_CONFIG_PARAMS_DEBUG //отладочные сообщения вышестоящего дефайна
#define SATIETY_SET_MAX_POWER          //сытость напрямую влияет на максимальную выносливость
//#define SATIETY_SET_MAX_POWER_DEBUG    //отладочные сообщения вышестоящего дефайна