...
enum EBodiesCollisionMode{
	eCollideNone	= 0,	//отключение коллизии живых тел с мертвымии и мертвых тел с мертвыми
	eCollideDead	= 1,	//отключение коллизии живых тел с мертвыми
	eCollideAny		= 2		//коллизия с мертвыми и живыми телами
};
