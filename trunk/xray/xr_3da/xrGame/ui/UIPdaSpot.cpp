...
{
	Msg("--[%s] adding user location: type: [%s], lname: [%s], pos: [%.5f, %.5f, %.5f]. Text: '%s'", __FUNCTION__, m_spotType.c_str(), m_levelName, m_position.x, m_position.y, m_position.z, m_editBox->GetText());
