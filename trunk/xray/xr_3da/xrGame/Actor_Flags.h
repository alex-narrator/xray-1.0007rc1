...
enum{
		...
		AF_FREE_HANDS                =(1<<10), //"свободные руки" - сокрытие двуручного оружия при обыске, доступе к инвентарю, работе с ПДА и применении быстрых слотов + обыск монстров с ножом
