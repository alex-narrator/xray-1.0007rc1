...
float		ps_r2_sun_near_border		= 1.0f;			    // 0.66f - prev value
float		ps_r2_sun_depth_far_scale	= 1.00000f;			// 1.00001f
float		ps_r2_sun_depth_far_bias	= 0.00000f;			// -0.0000f
float		ps_r2_sun_depth_near_scale	= 1.f;			    // 1.00001f - prev value
float		ps_r2_sun_depth_near_bias	= 0.f;		        // -0.00004f - prev value
