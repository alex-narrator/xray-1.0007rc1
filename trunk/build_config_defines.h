...
//#define SIMPLE_ZOOM_SETTINGS           //кратность оптики задаётся через степень увеличения а не fov, прицеливание без оптики не зуммирует (если не указан ironsight_zoom_factor) --дефолтное поведение
