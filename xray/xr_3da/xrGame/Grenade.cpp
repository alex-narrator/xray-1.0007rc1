...
void CGrenade::GetBriefInfo(xr_string& str_name, xr_string& icon_sect_name, xr_string& str_count)
{
	...
	/*xer-urg: “ут +1 в конце, т.к. обсчет кол-ва гранат дл€ показа на худе ведетс€ по кол-ву на по€се, 
	а есть еще граната в слоте. ј написать расчет слот+по€с € не умею*/
